...
create-leagent-conf:
	...
	sed -e "s;###USER_KEY###;${LOGENTRIES_USER_KEY};g" -e "s;###AGENT_KEY###;${LOGENTRIES_AGENT_KEY};g" -e "s;###LOGENTRIES_METRICS_TOKEN###;${LOGENTRIES_METRICS_TOKEN};g" conf/le_config.template.ini > "${OPENSHIFT_DATA_DIR}.le/config"
